...
|![Img](./media/115.png)|![Img](./media/178.png)|![Img](./media/181.png)| 
|MicroUSB线*1|电源适配器*1|面包板专用电源模块*1| 
|![Img](./media/137.jpg)|![Img](./media/116.png)|![Img](./media/A25.png)|
...
|![Img](./media/115.png)|![Img](./media/118.png)| ![Img](./media/119.png)|![Img](./media/117.png)|
|MicroUSB线*1|220Ω电阻*1|面包板连接线若干|红色LED*1|
![Img](./media/178.png)|![Img](./media/137.jpg)|![Img](./media/181.png)|![Img](./media/A25.png)|
...
按照接线图正确接好各元器件，将代码上传至Micro:bit主板。上传成功后，<span style="color: rgb(255, 169, 0);">外接电源供电，将面包板专用电源模块上的拨码开关拨到+5V端</span>。可以看到的现象是：当避障传感器检测到有障碍物时，避障传感器模块上的SLED灯亮，Micro:bit主板上的LED点阵显示“❤”图案，外接LED灯快速闪烁；否则，避障传感器模块上的SLED灯不亮，Micro:bit主板上的LED点阵显示“![Img](./media/145.png)”图案，外接LED灯熄灭。
...
|![Img](./media/117.png)|![Img](./media/118.png) |![Img](./media/178.png)|![Img](./media/181.png)|
...
按照接线图正确接好各元器件，将代码上传至Micro:bit主板。上传成功后，<span style="color: rgb(255, 169, 0);">外接电源供电，将面包板专用电源模块上的拨码开关拨到+5V端</span>。可以看到的现象是：当避障传感器检测到有障碍物时，避障传感器模块上的SLED灯亮，Micro:bit主板上的LED点阵显示“![Img](./media/146.png)”图案，有源蜂鸣器发出警报，外接LED灯快速闪烁。否则，避障传感器模块上的SLED灯不亮，Micro:bit主板上的LED点阵显示“![Img](./media/147.png)”图案，有源蜂鸣器不发声，外接LED灯熄灭。
